...
<body style="margin:0;font-family:Arial,sans-serif;background:#fdf2f8;padding:24px">
  <div style="max-width:480px;margin:0 auto;background:#fff;border-radius:16px;overflow:hidden;box-shadow:0 4px 16px rgba(0,0,0,0.08)">
    <div style="background:#db2777;padding:28px 24px;text-align:center">
      ...
      <p style="margin:8px 0 0;color:#fce7f3;font-size:14px">Recuperação de senha</p>
    </div>
    <div style="padding:32px 24px">
      ...
      <p style="margin:0 0 24px;color:#6b7280;font-size:15px;line-height:1.6">
        Recebemos um pedido para redefinir a senha da sua conta. Clique no botão abaixo — o link expira em <strong>1 hora</strong>.
      </p>
      <a href="${resetUrl}"
      ...
      <p style="margin:0;color:#d1d5db;font-size:11px;word-break:break-all">
