...
// Relatórios premium (Kit Consulta)
routes.get('/reports/weekly-summary', checkAuth, ReportController.weeklySummary)
routes.post('/reports/share', checkAuth, ReportController.createShareLink)
routes.get('/reports/share/:token', ReportController.getSharedReport)
routes.post('/reports/weekly-summary-email', checkCron, ReportController.sendWeeklySummaryEmails)
